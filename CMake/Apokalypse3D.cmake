...
MACRO (COMPILE_SHADER TYPE IN DIR_OUT GENERATED_FILES)
	SET (SUFFIX_PROFILE_120 gl/120)
	SET (SUFFIX_PROFILE_150 gl/150)
	SET (SUFFIX_PROFILE_410 gl/410)
	SET (SUFFIX_PROFILE_420 gl/420)
	SET (SUFFIX_PROFILE_430 gl/430)
	SET (SUFFIX_PROFILE_440 gl/440)
	SET (SUFFIX_PROFILE_spirv10-10 vk/10)
	SET (SUFFIX_PROFILE_spirv13-11 vk/13)
	SET (SUFFIX_PROFILE_spirv14-11 vk/14)
	SET (SUFFIX_PROFILE_spirv15-12 vk/15)
	SET (SUFFIX_PROFILE_spirv16-13 vk/16)
	SET (SUFFIX_PROFILE_metal metal)
	SET (SUFFIX_PROFILE_100_es gles/100)
	SET (SUFFIX_PROFILE_300_es gles/300)
	SET (SUFFIX_PROFILE_310_es gles/310)
	SET (SUFFIX_PROFILE_320_es gles/320)
	SET (SUFFIX_PROFILE_s_3_0 dx/30)
	SET (SUFFIX_PROFILE_s_5_0 dx/50)
	...
	ENDIF ()
	SET (PROFILES_OPENGL 120 150 410 420 430 440)
	SET (PROFILES_VULKAN spirv10-10 spirv13-11 spirv14-11 spirv15-12 spirv16-13)
	SET (PROFILES_DX s_3_0 s_5_0)
	SET (PROFILES_METAL metal)
	SET (PROFILES_OPENGLES 100_es 300_es 310_es 320_es)
	IF (WIN32)
